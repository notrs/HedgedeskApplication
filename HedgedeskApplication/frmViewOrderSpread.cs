...
{
    public partial class frmViewOrderSpread : Form
    {
        ...
        private void frmAddOrder_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                string ParentID = viewOrder[0]["Parent"].ToString();
                if (SpreadID == "")
                {
                    SpreadID = mOrderNumber.ToString();
                }
                ...
                GlobalStore.FillOrderDetailDataTable(SpreadID.ToString());
                GlobalStore.FillOrderViewDataTable(SpreadID.ToString());
