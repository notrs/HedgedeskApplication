...
{
    public partial class frmECPartialFills : Form
    {
        ...
        private void dgvECOrders_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (dgvECOrders.Columns[e.ColumnIndex].Name == "SFFill")
            {
                ...
                if (Applied == "1")
                {
                    MessageBox.Show("This fill has already been applied.", "Partial Fill");
                    return;
                }
                else if (CompletedFill == "1")
                {
                    MessageBox.Show("This fill has been completed.", "Partial Fill");
                    return;
                }
                else
                {
                    ...
                    //    mdtECSplitOrders = GlobalStore.FillECPartialOrdersDataSet().Tables[0];
            ...
            else if (dgvECOrders.Columns[e.ColumnIndex].Name == "CreateRecord")
            {
                ...
                else
                {
                    ...
                    txtRemainingQty.Text = RemainingQuantity.ToString();
                    mdtECSplitOrders.Clear();
                    dvECSplitOrders = mdtECSplitOrders.DefaultView;
                    GlobalStore.mdsECSplitOrders.Clear();
                    mdtECSplitOrders = GlobalStore.FillECPartialOrdersDataSet().Tables[0];
            ...
            else if (dgvECOrders.Columns[e.ColumnIndex].Name == "FillOriginal")
            {
                ...
                if (OrderSent != "" && OrderSent != "1")
                {
                    if (OrderSent == "5")
                    {
                        if (MessageBox.Show(this, ReturnMessage.ToString(), "Partial Fill", MessageBoxButtons.OKCancel) == DialogResult.OK)
                        {
                            ordUpdate.AddSplitFillOriginal(mOrderNumber, Applied, CompletedFill, ref ReturnMessage,
                                                ref OrderSent, mTradeCompany, MessageID, FilledPrice, FillQty,
                            ...
                            else
                            {
                                ...
                                //MessageBox.Show(this, "Original Filled", "Partial Fill");
                ...
                else
                {
                    ...
                    //MessageBox.Show(this, "Fill Completed", "Partial Fill");
                    frmCopyOrders.RefreshOrderGrid();
                    txtRemainingQty.Text = RemainingQuantity.ToString();
                    mdtECSplitOrders.Clear();
                    dvECSplitOrders = mdtECSplitOrders.DefaultView;
        ...
        private void frmECPartialFills_FormClosing(object sender, FormClosingEventArgs e)
        {
            GlobalStore.mdsECPartialOrders.Clear();
            frmCopyOrders.dtECPartialOrders.Clear();
            GlobalStore.mdsECPartialOrders.Clear();
            frmCopyOrders.dtECPartialOrders = GlobalStore.FillECPartialOrdersDataSet().Tables[0];
