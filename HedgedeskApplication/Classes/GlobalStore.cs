...
namespace HedgedeskApplication
{
    public static class GlobalStore
    {
        ...
        public static DataTable FillOrderDataTableFromRegionOrder(int RegionOrderNumber)
        {
            ...
            SqlCommand myCMD = new SqlCommand();
            myCMD.CommandText = "proc_GetOrder";
            myCMD.Parameters.Add("@OrderNumber", SqlDbType.Int).Value = Convert.ToInt32(RegionOrderNumber);
            myCMD.CommandType = CommandType.StoredProcedure;
            myCMD.Connection = Conn;
            SqlDataAdapter adapter = new SqlDataAdapter(myCMD);
            Conn.Open();
        ...
        public static DataTable FillSingleRegionOrderDataTable(string RequestID)
        {
            DataTable order = new DataTable();
            SqlConnection Conn = new SqlConnection();
            Conn.ConnectionString = Properties.Settings.Default.HedgedeskConnectionString;
